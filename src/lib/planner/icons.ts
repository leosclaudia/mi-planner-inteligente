...
export const SECTION_COLORS = ["terra", "olive", "sun", "plum", "cielo", "rosa"] as const;
...
export const COLOR_CLASSES: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  cielo: { bg: "bg-cielo-soft", text: "text-cielo", dot: "bg-cielo" },
  rosa: { bg: "bg-rosa-soft", text: "text-rosa", dot: "bg-rosa" },
};
