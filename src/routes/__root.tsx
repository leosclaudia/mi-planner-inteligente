  ...
  head: () => ({
    meta: [
      ...
      { title: "Planner Inteligente Personalizable" },
      {
        name: "description",
        content:
          "Agenda personal mobile-first para organizar tu día, semana y mes con secciones a tu medida.",
      },
      { name: "theme-color", content: "#f8f3e9" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Mi Planner" },
